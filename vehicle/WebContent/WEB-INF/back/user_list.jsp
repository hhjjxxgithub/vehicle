...
<body class="app ">
    ...
    <div class="main-wrapper">
      <div class="app-content">
        ...
        <footer class="main-footer">
          <div class="text-center">Copyright &copy;Kharna-Admin 2018. Design By<a href="https://spruko.com/"> Spruko</a>
          </div>
        </footer>
      </div>
    </div>
  ...
  <!--   分配教练 -->
            ...
            <form class="form-horizontal" id="form">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-4">
                  ...
                  <input type="hidden" class="form-control" id="userId" name="userId" required="true">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-md-4 col-form-label">所属驾校</label>
                <div class="col-md-4">
                  <input type="text" class="form-control" placeholder="Card" id="schoolName" name="schoolName" required="true">
                  <input type="hidden" class="form-control" id="schoolId" name="schoolId" required="true">
                </div>
              </div>
              <div class="form-group row">
    ...
    <!--   查看学时 -->
    <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="studyTime">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title" id="myModalLabel">学时详情</h4>
