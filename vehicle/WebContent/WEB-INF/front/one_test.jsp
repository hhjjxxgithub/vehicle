        ...
        <table  align="center">
            <tbody id="tbody">
	         ...
	         <%--        	<td colspan='4'>${(page-1)*10+c.count}、${subject.SUBJECT_TITLE}</td> --%>
                	...
                	<tr>
	                	<td><input type='radio' name='${subject.SUBJECT_ID}' value='${subject.SUBJECT_SCOREA}'>${subject.SUBJECT_OPTIONA}</input></td>
	                	<td><input type='radio' name='${subject.SUBJECT_ID}' value='${subject.SUBJECT_SCOREB}'>${subject.SUBJECT_OPTIONB}</input></td>
	                	<td><input type='radio' name='${subject.SUBJECT_ID}' value='${subject.SUBJECT_SCOREC}'>${subject.SUBJECT_OPTIONC}</input></td>
	                	<td><input type='radio' name='${subject.SUBJECT_ID}' value='${subject.SUBJECT_SCORED}'>${subject.SUBJECT_OPTIOND}</input></td>
	                </tr>
                	</c:forEach>
            </tbody>
        </table>
